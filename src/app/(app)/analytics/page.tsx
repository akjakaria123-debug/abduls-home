      ...
      {publishedPosts.length === 0 ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            <Card>
              <CardContent>
                <p className="text-xs uppercase tracking-wide text-slate-500">People reached</p>
            ...
            <Card>
              <CardContent>
                <p className="text-xs uppercase tracking-wide text-slate-500">Reactions</p>
                <p className="text-2xl font-semibold text-slate-900">
          ...
          <Card>
            <CardHeader>
              <h2 className="text-sm font-semibold text-slate-900">Per post</h2>
            </CardHeader>
